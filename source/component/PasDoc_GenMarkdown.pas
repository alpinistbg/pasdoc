...
type
  ...
  protected
    ...
    function SearchLink(s: string; const Item: TBaseItem; const LinkDisplay: string;
      const WarningIfLinkNotFound: TLinkNotFoundAction; out FoundItem: TBaseItem
      ): string; overload;
    function SearchLink(s: string; const Item: TBaseItem; const LinkDisplay: string;
...
function TMarkdownDocGenerator.SearchLink(s: string; const Item: TBaseItem;
  const LinkDisplay: string; const WarningIfLinkNotFound: TLinkNotFoundAction;
